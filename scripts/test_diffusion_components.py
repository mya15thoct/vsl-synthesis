...
gt = torch.tensor(data['ground_truth'].copy(), dtype=torch.float32).cuda()  # (5, 1659)
start = torch.tensor(data['start_pose'].copy(), dtype=torch.float32).cuda()  # (1659,)
end = torch.tensor(data['end_pose'].copy(), dtype=torch.float32).cuda()  # (1659,)
